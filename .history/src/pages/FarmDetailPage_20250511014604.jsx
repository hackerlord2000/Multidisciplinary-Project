...
export default function FarmDetailPage() {
  ...
  const [sunlight, setSunlight] = useState(
    initialStatus.sunlight >= 95 ? "Very High" :
    initialStatus.sunlight >= 80 ? "High" :
    initialStatus.sunlight >= 60 ? "Medium" :
    initialStatus.sunlight >= 40 ? "Low" :
    initialStatus.sunlight >= 20 ? "Very Low" :
    "None"
  );
